...
app.add_url_rule('/v1.0/changerole','change_role_api', dbmodels.change_role_api, methods=['PUT'])
app.add_url_rule('/v1.0/getrole','retrieve_role_api', dbmodels.retrieve_role_api, methods=['GET'])